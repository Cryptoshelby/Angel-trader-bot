...
const HORARIOS = [
    ...
    { inicio: 8, fin: 12, nombre: '☀️ MAÑANA' },
    { inicio: 16, fin: 20, nombre: '🌤️ TARDE' }
];
...
function formatoHora(f) { return f.toLocaleTimeString('es-ES', { hour: '2-digit', minute: '2-digit', timeZone: 'America/La_Paz' }); }
...
async function enviarSenal() {
    ...
    try {
        ...
        const mensaje = '💰 *SEÑAL FOREX - QUOTEX*\n' + '━'.repeat(30) + '\n\n' +
            ...
            '⏰ *ENTRADA:* ' + formatoHora(entrada) + ' UTC-4\n🎯 *DIRECCIÓN:* ' + dir + '\n\n' +
            '⏳ *VENCIMIENTO:* 5 minutos\n🕐 HORA: *' + formatoHora(vence) + ' UTC-4*\n\n' +
            '📈 *GALES:*\n1ª GALE → *' + formatoHora(g1) + ' UTC-4*\n2ª GALE → *' + formatoHora(g2) + ' UTC-4*\n\n' +
...
console.log('🕐 Horarios UTC-4: 01-03, 08-12, 16-20');
